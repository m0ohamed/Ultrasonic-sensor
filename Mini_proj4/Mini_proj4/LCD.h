...
#define LCD_E_BIT_PORT_ID            PORTB_ID
#define LCD_E_BIT_PIN_ID             PIN1_ID

#define LCD_RS_BIT_PORT_ID            PORTB_ID
#define LCD_RS_BIT_PIN_ID             PIN0_ID

#define DATA_BUS_PORT_ID              PORTA_ID
